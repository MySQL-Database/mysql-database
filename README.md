...
<center>
	<a href="https://nodei.co/npm/mysql-database/">
		<img alt="mysql-database NPM Package Statistics" src="https://nodei.co/npm/mysql-database.png">
	</a>
</center>
...
# Installation from [NPM](https://www.npmjs.com/package/mysql-database)
...
async function run(){
	...
	*/
	...
	let processList = await db.process();
